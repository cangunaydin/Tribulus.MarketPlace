...
public abstract class CompositionService :
...
IGlobalFeatureCheckingEnabled
{
    ...
    public static string[] CommonPostfixes { get; set; } = { "SubscriptionService", "CompositionService", "Service" };

    public List<string> AppliedCrossCuttingConcerns { get; } = new();

    protected ICompositionContext CompositionContext => LazyServiceProvider.LazyGetRequiredService<ICompositionContext>();
