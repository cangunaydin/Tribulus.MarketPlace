...
public class MarketPlaceHttpApiHostModule : AbpModule
{
    ...
    {
        Configure<AbpDistributedCacheOptions>(options => { options.KeyPrefix = "MarketPlace:"; });
    }
    ...
    private void ConfigureVirtualFileSystem(ServiceConfigurationContext context)
    {
        ...
        if (hostingEnvironment.IsDevelopment())
        {
            Configure<AbpVirtualFileSystemOptions>(options =>
            {
                ...
                options.FileSets.ReplaceEmbeddedByPhysical<MarketPlaceApplicationContractsModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}Tribulus.MarketPlace.Application.Contracts"));
                options.FileSets.ReplaceEmbeddedByPhysical<MarketPlaceApplicationModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}Tribulus.MarketPlace.Application"));
            });
        }
    }
    ...
    private void ConfigureConventionalControllers()
    {
        ...
        {
            options.ConventionalControllers.Create(typeof(MarketPlaceApplicationModule).Assembly);
        });
    }
    ...
    public override void OnApplicationInitialization(ApplicationInitializationContext context)
    {
        ...
        app.UseAbpSwaggerUI(options =>
        {
            ...
            options.OAuthScopes("MarketPlace");
        });
