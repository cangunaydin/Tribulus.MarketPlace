...
public class MarketPlaceAuthServerModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.Applications["MVC"].RootUrl = MarketPlaceUrlOptions.GetAccountConfigValue(configuration);
        ...
        {
            options.Issuer = new Uri(MarketPlaceUrlOptions.GetAccountConfigValue(configuration));
        });
