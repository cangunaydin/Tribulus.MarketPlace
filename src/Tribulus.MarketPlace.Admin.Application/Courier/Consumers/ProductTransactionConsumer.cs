...
namespace Tribulus.MarketPlace.Admin.Courier.Consumers
{
    ...
    { 
        ...
        {
            _logger = logger;
            _marketingUri = new Uri(EndpointsUri.BaseUri + EndpointsUri.ProductMarketingActivityUri);
            _inventoryUri = new Uri(EndpointsUri.BaseUri + EndpointsUri.ProductInventoryActivityUri);
        }
