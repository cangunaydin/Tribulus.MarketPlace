...
public class AdminInventoryHttpApiHostModule : AbpModule
{
    ...
    {
        var dataProtectionBuilder = context.Services.AddDataProtection().SetApplicationName("AdminInventory");
        if (!hostingEnvironment.IsDevelopment())
        {
    ...
    public override void OnApplicationInitialization(ApplicationInitializationContext context)
    {
        ...
        {
            options.SwaggerEndpoint("/swagger/v1/swagger.json", "Market Place Admin Inventory API");
