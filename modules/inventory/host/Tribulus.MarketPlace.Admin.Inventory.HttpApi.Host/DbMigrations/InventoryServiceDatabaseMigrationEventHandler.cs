...
public class InventoryServiceDatabaseMigrationEventHandler
    : DatabaseMigrationEventHandlerBase<InventoryDbContext>,
        IDistributedEventHandler<TenantCreatedEto>,
        IDistributedEventHandler<TenantConnectionStringUpdatedEto>,
        IDistributedEventHandler<ApplyDatabaseMigrationsEto>
{
    public InventoryServiceDatabaseMigrationEventHandler(
