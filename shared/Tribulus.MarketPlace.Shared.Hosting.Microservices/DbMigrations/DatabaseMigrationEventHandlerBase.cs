...
namespace Tribulus.MarketPlace.Shared.Hosting.Microservices.DbMigrations;
    ...
    where TDbContext : DbContext, IEfCoreDbContext
{
    ...
    protected virtual async Task QueueTenantMigrationsAsync()
    {
        var tenants = (await TenantRepository.GetListAsync())
            .Where(u => u.ConnectionStrings.Any(c => c.Name == ConnectionStrings.DefaultConnectionStringName && c.Value != null))
            .ToList();
